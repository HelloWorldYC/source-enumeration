...
x = x1+x2+x3;
x = x';
[Yl,Yh,Yscale] = dtwavexfm(x,level,'near_sym_b','qshift_b');%Yh中从高频到低频
for j = 1:level
...
%     z=emd(signal);
    ...
    [BIC,Ns_BIC(cc)] = func_IBIC(1/(M1*L),M1,L,R1);
...
plot(snr,Pd_GDE_sparse,'>-',snr,Pd_BIC_sparse,'rs-',snr,Pd_GDE,'o-',snr,Pd_BIC,'b^-',snr,Pd_MIC,'gs-');
