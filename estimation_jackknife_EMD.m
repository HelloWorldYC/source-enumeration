%% 程序说明
%  功能： 先利用刀切法将单通道信号分段，再用emd分解，最后估计
%  码猿： 马叶椿
%  版本： v1.0 - 2022.01.16
%         v2.0 - 2022.01.18
%         v3.0 - 2022.05.14
...
%         resignal = [signal_jackknife(i,:);resignal'];
        ...
        [IBIC,frequency_IBIC(i)] = func_IBIC(1/(M*L_jk),M,L_jk,R);
    ...
    Ns_IBIC(cc) = mode(frequency_IBIC);
...
%%
plot(snr,Pd_GDE,'>-',snr,Pd_IBIC,'rs-',snr,Pd_MIC,'o-',snr,Pd_MSTDC,'b^-',snr,Pd_MDL,'gs-');
